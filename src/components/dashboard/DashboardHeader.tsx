    ...
    <header className="flex flex-col gap-3 border-b border-gray-100 bg-white px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:px-6 lg:px-8 lg:py-4">
      <div className="flex min-w-0 items-center gap-3 sm:gap-6 lg:gap-8">
        ...
        <div className="min-w-0 pl-1 sm:pl-2">
          <p className="truncate text-sm font-semibold text-gray-800">Syed Mesum Raza</p>
          <p className="truncate text-sm text-gray-500">Welcome to Avtive 👋</p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2 sm:justify-end sm:gap-3">
        ...
        <Button variant="outline" className="gap-1.5 rounded-lg px-2.5 text-xs font-medium sm:px-3">
          <Eye className="size-4" />
          <span className="hidden sm:inline">Preview</span>
        </Button>
        <Button className="gap-1.5 rounded-lg bg-[#4361ee] px-2.5 text-xs font-medium text-white hover:bg-[#3a56d4] sm:px-3">
