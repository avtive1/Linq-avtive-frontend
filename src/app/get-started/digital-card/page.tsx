  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-[#F9FAFB]">
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-6 sm:px-8">
        <div className="h-[360px] w-full max-w-[700px] rounded-2xl border-2 border-purple-400/50 bg-gradient-to-r from-sky-50 via-white to-amber-50 shadow-sm sm:h-[500px]" />
      </div>
    </div>
  )
}
