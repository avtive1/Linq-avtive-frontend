      ...
      <div className="flex flex-1 flex-col overflow-auto">
        ...
        <div className="flex flex-1 gap-6 p-8">
          ...
          <div className="flex-1 max-w-3xl">
            ...
            <div className="mb-6 flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 py-16">
              <Upload className="size-12 text-gray-400 mb-4" />
              <p className="text-sm font-semibold text-gray-900 mb-1">Select image to upload</p>
              <p className="text-xs text-gray-500 mb-4">Select or drag a file here</p>
