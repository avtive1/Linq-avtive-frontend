...
export default function LoginIncorrectPasswordPage() {
            ...
            <div className="flex w-full flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="email"
                    type="email"
                    defaultValue="hello@ailgnui.com"
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-11 rounded-lg border-red-300 bg-gray-50/50 pl-10 pr-10 text-sm focus:border-red-400 focus:ring-red-200"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <label htmlFor="keepLoggedIn" className="text-sm text-gray-500 cursor-pointer select-none">
                    Keep me logged in
                  </label>
                </div>
                <a href="/reset-password" className="text-sm font-medium text-[#4361ee] underline underline-offset-2 hover:text-[#3a56d4]">
                  Forgot password?
                </a>
              </div>
            </div>
