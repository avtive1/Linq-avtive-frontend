...
import {
  ...
  Download, ArrowLeftRight, Mail, Phone, MapPin, User, Share2
} from "lucide-react"
    ...
    <div className="flex min-h-screen w-full bg-[#F9FAFB]">
      ...
      <div className="flex flex-1 flex-col overflow-auto">
        ...
        <div className="flex gap-6 border-b border-gray-100 bg-white px-8 py-3 text-sm">
          ...
          <span className="font-medium text-[#4361ee] border-b-2 border-[#4361ee] pb-2">Company Settings</span>
          ...
          <div className="w-[220px] shrink-0">
            <div className="rounded-xl border border-gray-200 bg-white p-4">
              ...
              <nav className="flex flex-col gap-1">
                {menuItems.map((item) => (
                  <button key={item.label} className={`flex items-center gap-2 rounded-lg px-3 py-2.5 text-sm ${
